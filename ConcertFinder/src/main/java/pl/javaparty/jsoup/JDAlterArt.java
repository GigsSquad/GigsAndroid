...
public class JDAlterArt {
	...
	/*
	 * Baz? nale?y aktualizowa? je?eli: - jeszcze nie mamy danych z tej strony - dane tej strony s? przestarza?e (dodano
	 * nowe koncerty) - sprawdzamy to por?wnuj?c hashcody TABELI koncert?w (inaczej ni? w GoAhead)
	 */
